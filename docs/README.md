# ClimateOS Documentation Index

## Purpose

This folder contains repository documentation for ClimateOS / eco-agent-system.

The documentation supports governance, maintainability, onboarding, radar,
observation, validation, task tracking, release records, and future skills.
