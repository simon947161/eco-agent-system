...
│   ├─► CarbonOS: PASS/FAIL/CONDITIONAL
│   ├─► WaterOS: PASS/FAIL/CONDITIONAL
│   ├─► EnergyOS: PASS/FAIL/CONDITIONAL
│   ├─► BuildingOS: PASS/FAIL/CONDITIONAL
│   └─► Climate Data: PASS/FAIL/CONDITIONAL
│
└─► Determine Overall Result
    │
    ├─► ALL 5 SCENARIOS PASS → GRADUATION: PASS
    │
    ├─► 4 PASS + 1 CONDITIONAL → GRADUATION: CONDITIONAL
    │
    ├─► 3 PASS + 2 FAIL → GRADUATION: CONDITIONAL (remediation required)
    │
    ├─► ≤2 PASS → GRADUATION: FAIL
    │
    └─► 3+ FAILURES → GRADUATION: FAIL (significant gaps)
```
...
| Evidence Test | 100% guidelines | >80% guidelines | ≤80% guidelines |
| Validation Test | 100% human-executable | >80% human-executable | ≤80% human-executable |
| Governance Test | 100% assigned | 90-99% assigned | <90% assigned |
| Inheritance Test | 100% mapped | 90-99% mapped | <90% mapped |
| Criteria | All pass | >80% pass | ≤80% pass |
